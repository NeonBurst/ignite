        ...
        if (!cameraPermissionHelper.hasCameraPermission()) {
            ...
            try {
                ...
                Toast.makeText(this, "TODO: handle exception " + e, Toast.LENGTH_LONG)
                    .show()
                return
            } catch (e: UnknownError) { // TODO Handle no camera permission
                Toast.makeText(this, "Camera permission is needed to run this application none was given", Toast.LENGTH_LONG)
                    .show()
